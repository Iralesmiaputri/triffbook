    ...
    <div class="row">
     <div class="col-lg-12">
      ...
      <table style="width: 100%;">
        ...
        <h5 id="judul"><b>Laporan Ketersediaan Stok buku</b></h5> <br>
        ...
        <div class="table-responsive">
         <table class="table table-bordered">
           <thead>
            <tr>
             ...
             <th width="20%" id="judul">Stok Saat Ini</th>
         ...
         <tbody>
          ...
          $no=1;
           ...
           foreach($buku as $p){ 
            ...
            <tr>
              <td><?php echo $no++; ?></td>
             <td id="judul"><?php echo $p->buku_nama; ?></td>
             <td id="judul"><?php echo $p->buku_stok; ?> Pcs</td>
         ...
         <tr>
          <td></td>
          <td  id="judul" >Total Buku </td>
          <td id="left"  ><?php echo $grandtotal; ?> Pcs</td>
        </tr>
