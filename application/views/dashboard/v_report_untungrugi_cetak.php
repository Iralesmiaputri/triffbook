  ...
  <div class="content-wrapper">
   ...
   <section class="content">
    <div class="row">
     ...
     <table style="width: 100%;">
        ...
        <h5 id="judul"><b>Laporan Keuntungan dan Kerugian</b></h5> <br>
        <br>
        <div class="table-responsive">
         <table class="table table-bordered">
           <thead>
            <tr> 
             ...
             <th width="30%" id="judul">Judul buku</th>
             <th width="25%" id="judul">Tanggal Setor</th>
             <th width="5%" id="judul">Ket</th>
             <th width="20%" id="judul">Total</th>
              <th width="5%" id="judul">Berat</th>
         ...
         <tbody>
           ...
           foreach($setor as $p){ 
            ...
            <tr>
             ...
             <td><?php echo $p->setor_berat; ?> Kg</td>
         ...
         ?>
         <tr>
          <td colspan="5" id="judul" >Jumlah Pengeluaran</td>
        ...
        <div class="table-responsive">
         ...
         ?>
         <tr>
          <td  id="judul" colspan="4">Jumlah Pendapatan </td>
          <td >Rp <?php echo number_format($grandtotal2, 0,'.','.') ?></td>
        </tr>
   ...
   <div class="table-responsive">
         <table class="table table-bordered">
           <thead>
            <tr>
        <th id="judul" >Total Keuntungan dan Kerugian</th>
         ...
         <tr>
          <?php 
         $untungrugitotal =$grandtotal2-$grandtotal;
         ?>
          <td id="judul" > Rp <?php echo number_format($untungrugitotal, 0,'.','.') ?></td>
        </tr>
