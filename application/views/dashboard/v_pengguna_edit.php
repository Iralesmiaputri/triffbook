                     ...
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <select class="form-control" name="level">
                              ...
                              <option
                                 <?php if($p->pengguna_level == "nasabah"){ echo "selected='selected'";} ?> value="nasabah">Nasabah</option>
                           </select>
         ...
         <div class="col-lg-6">
            ...
            <div class="box box-primary">
               ...
               <div class="box-body">
                  <?php foreach($pengguna as $p){ 
                     if($p->pengguna_foto != ""){?>
                     <iframe src="<?php echo base_url('/profil/'.$p->pengguna_foto); ?>" width="550" height="600" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
                  <?php }} ?>
               </div>
            </div>
         </div>
