                  ...
                  <form method="post" action="<?php echo
                     ...
                     <div class="box-body">
                        <div class="form-group">
                           <label>No KTP</label>
                           <input type="text"
                              name="ktp" class="form-control" placeholder="Masukkan NIK ..">
                           <?php echo
                              form_error('ktp'); ?>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <input type="text"
                              name="tlp" class="form-control" placeholder="Masukkan No HP .." require>
                           <?php echo
                              form_error('tlp'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <input type="text"
                              name="rek" class="form-control" placeholder="Masukkan rekening pengguna..">
                           <?php echo
                              form_error('rek'); ?>
                        </div>
                        <div class="form-group">
