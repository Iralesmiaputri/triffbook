    ...
    <div class="row">
     <div class="col-lg-12">
      ...
      <table style="width: 100%;">
        ...
        <h5 id="judul"><b>Laporan Setoran buku</b></h5> <br>
        ...
        <div class="table-responsive">
         <table class="table table-bordered">
           <thead>
            <tr>
                <th id="judul1">No</th>
             <th width="20%" id="judul1">Penyetor</th>
             <th width="20%" id="judul1">Jenis buku</th>
             <th width="25%" id="judul1">Tanggal Setor</th>
             <th width="20%" id="judul1">Total</th>
              <th width="20%" id="judul1">Pcs</th>
         ...
         <tbody>
           ...
           $total=0;
              $no=1;
           foreach($setor as $p){ 
            $jumlah = $p->setor_berat;
            $total+=$jumlah;
            ?>
            <tr>
              <td id="judul2"><?php echo $no++; ?></td>
             <td id="judul2"><?php echo $p->pengguna_nama; ?></td>
             <td id="judul2"><?php echo $p->buku_nama; ?></td>
             
             <td id="judul2"><?php echo date('d-M-Y', strtotime($p->setor_tgl)); ?></td>
           
             <td id="judul2">Rp <?php echo number_format($p->setor_jumlah, 0,'.','.') ?></td>
             <td id="judul2"><?php echo $p->setor_berat; ?> Pcs</td>
         ...
         ?>
         <tr>
          <td colspan="5" id="judul1" >Total Pcs</td>
          <td   id="right"> <?php echo $grandtotal; ?> Pcs</td>
        </tr>
