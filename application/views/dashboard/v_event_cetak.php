   ...
   <section class="content">
    <div class="row">
     ...
     <table style="width: 100%;">
        ...
        <h5 id="judul"><b>Laporan Efektifitas Event</b> </h5> <br>
        ...
        <div class="table-responsive">
         <table class="table table-bordered">
           <thead>
            <tr>
             <th  id="judul">No</th>
             <th  id="judul">Nama Event</th>
             <th  id="judul">Tanggal Event</th>
             <th width="20%" id="judul">Buku terjual</th>
             <th width="20%" id="judul">Total Transaksi</th>
           </tr>
         </thead>
         <tbody>
          <?php
           ...
           foreach($event as $p){
            ...
            <td id="judul"><?php echo $no++; ?></td>
             <td id="judul"><?php echo $p->event_nama; ?></td>
             <td id="judul"><?php echo date('d-M-Y', strtotime($p->event_tgl)); ?></td>
             <td id="judul"><?php echo $p->jumlah; ?> Buku</td>
             <td id="judul"><?php echo $p->jumlah2; ?> Transaksi</td>
